...
static const std::map<llm_arch, const char *> LLM_ARCH_NAMES = {
    ...
    { LLM_ARCH_HMT,              "hmt"              }, //HMT Arch name mapping
    { LLM_ARCH_DECI,             "deci"             },
...
static const std::map<llm_arch, std::map<llm_tensor, const char *>> LLM_TENSOR_NAMES = {
        ...
        }, },
    {
     LLM_ARCH_HMT, {
            ...
            { LLM_TENSOR_FFN_DOWN_EXPS, "blk.%d.ffn_down_exps" },
            { LLM_TENSOR_FFN_UP_EXPS, "blk.%d.ffn_up_exps" },
            { LLM_TENSOR_HMT_CROSS_Q, "hmt.cross_attn_q" },
            { LLM_TENSOR_HMT_CROSS_K, "hmt.cross_attn_k" },
            { LLM_TENSOR_HMT_MEM_MAP_LIN, "hmt.mem_map.linear" },
            { LLM_TENSOR_HMT_MEM_MAP_INV, "hmt.mem_map.inv" },
            { LLM_TENSOR_HMT_INITIAL_MEMORY, "hmt.initial_memory" },
            { LLM_TENSOR_HMT_SUMMARY_PROMPT, "hmt.summary_prompt" },
        }, },
    {
     LLM_ARCH_ARCEE, {
            { LLM_TENSOR_TOKEN_EMBD, "token_embd" },
    ...
    {
     LLM_ARCH_FALCON_H1, {
            { LLM_TENSOR_TOKEN_EMBD, "token_embd" },    { LLM_TENSOR_OUTPUT, "output" },
            { LLM_TENSOR_OUTPUT_NORM, "output_norm" },  { LLM_TENSOR_ATTN_NORM, "blk.%d.attn_norm" },
            { LLM_TENSOR_ATTN_Q, "blk.%d.attn_q" },     { LLM_TENSOR_ATTN_K, "blk.%d.attn_k" },
            { LLM_TENSOR_ATTN_V, "blk.%d.attn_v" },     { LLM_TENSOR_ATTN_OUT, "blk.%d.attn_output" },
            { LLM_TENSOR_SSM_IN, "blk.%d.ssm_in" },     { LLM_TENSOR_SSM_CONV1D, "blk.%d.ssm_conv1d" },
            { LLM_TENSOR_SSM_DT, "blk.%d.ssm_dt" },     { LLM_TENSOR_SSM_A, "blk.%d.ssm_a" },
            { LLM_TENSOR_SSM_D, "blk.%d.ssm_d" },       { LLM_TENSOR_SSM_NORM, "blk.%d.ssm_norm" },
            { LLM_TENSOR_SSM_OUT, "blk.%d.ssm_out" },   { LLM_TENSOR_FFN_NORM, "blk.%d.ffn_norm" },
            { LLM_TENSOR_FFN_GATE, "blk.%d.ffn_gate" }, { LLM_TENSOR_FFN_DOWN, "blk.%d.ffn_down" },
            { LLM_TENSOR_FFN_UP, "blk.%d.ffn_up" },
        }, },
    {
     LLM_ARCH_XVERSE, {
    ...
    {
     LLM_ARCH_SMALLTHINKER, { { LLM_TENSOR_TOKEN_EMBD, "token_embd" },
          { LLM_TENSOR_OUTPUT_NORM, "output_norm" },
          { LLM_TENSOR_OUTPUT, "output" },
          { LLM_TENSOR_ATTN_NORM, "blk.%d.attn_norm" },
          { LLM_TENSOR_ATTN_Q, "blk.%d.attn_q" },
...
static const std::map<llm_tensor, llm_tensor_info> LLM_TENSOR_INFOS = {
    ...
    //HMT Tensors
    { LLM_TENSOR_HMT_CROSS_Q,            { LLM_TENSOR_LAYER_INPUT, GGML_OP_MUL_MAT }        },
    { LLM_TENSOR_HMT_CROSS_K,            { LLM_TENSOR_LAYER_INPUT, GGML_OP_MUL_MAT }        },
    { LLM_TENSOR_HMT_SUMMARY_PROMPT,     { LLM_TENSOR_LAYER_INPUT, GGML_OP_ADD }            },
    { LLM_TENSOR_HMT_INITIAL_MEMORY,     { LLM_TENSOR_LAYER_INPUT, GGML_OP_MUL_MAT }        },
    { LLM_TENSOR_HMT_MEM_MAP_LIN,        { LLM_TENSOR_LAYER_INPUT, GGML_OP_MUL_MAT }        },
    { LLM_TENSOR_HMT_MEM_MAP_INV,        { LLM_TENSOR_LAYER_INPUT, GGML_OP_MUL_MAT }        },
};
