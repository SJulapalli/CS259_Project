...
enum llm_tensor {
    ...
    LLM_TENSOR_HMT_CROSS_Q,  //HMT Tensors
    LLM_TENSOR_HMT_CROSS_K,
    LLM_TENSOR_HMT_SUMMARY_PROMPT,
    LLM_TENSOR_HMT_INITIAL_MEMORY,
    LLM_TENSOR_HMT_MEM_MAP_LIN,
    LLM_TENSOR_HMT_MEM_MAP_INV,
};
