...
struct llama_model {
    ...
    // HMT Tensors
    struct ggml_tensor * hmt_cross_q        = nullptr;  // hmt.cross_q.weight
    struct ggml_tensor * hmt_cross_k        = nullptr;  // hmt.cross_k.weight
    struct ggml_tensor * hmt_mem_map_lin    = nullptr;  // hmt.mem_map.linear.weight
    struct ggml_tensor * hmt_mem_map_inv    = nullptr;  // hmt.mem_map.inv.weight
    struct ggml_tensor * hmt_summary_prompt = nullptr;  // "hmt.summary_prompt"
    struct ggml_tensor * hmt_initial_memory = nullptr;  // "hmt.initial_memory"
