...
// Forward declaring for use with HMT
...
class llm_graph_input_mem_hybrid : public llm_graph_input_i {
  public:
    llm_graph_input_mem_hybrid(std::unique_ptr<llm_graph_input_attn_kv> inp_attn,
...
struct llm_graph_params {
    ...
    // Context necessary for HMT memory storage.
    ...
    bool allow_reuse(const llm_graph_params & other) const {
        ...
        return cparams.embeddings == other.cparams.embeddings && cparams.causal_attn == other.cparams.causal_attn &&
               ...
               cross == other.cross && n_outputs == other.n_outputs;
    }
};
