...
MODEL_ARCH_NAMES: dict[MODEL_ARCH, str] = {
    ...
    MODEL_ARCH.HMT:              "hmt",  # HMT Model enum name mapping
...
TENSOR_NAMES: dict[MODEL_TENSOR, str] = {
    ...
    # HMT maps
    MODEL_TENSOR.CROSS_ATTN_Q:            "hmt.cross_attn_q",
    MODEL_TENSOR.CROSS_ATTN_K:            "hmt.cross_attn_k",
    MODEL_TENSOR.SUMMARY_EMBEDDING:       "hmt.summary_prompt",
    MODEL_TENSOR.INITIAL_MEMORY:          "hmt.initial_memory",
    MODEL_TENSOR.LINEAR_WEIGHT:           "hmt.mem_map.linear",
    MODEL_TENSOR.INV_WEIGHT:              "hmt.mem_map.inv",
}
...
MODEL_TENSORS: dict[MODEL_ARCH, list[MODEL_TENSOR]] = {
    ...
    MODEL_ARCH.HMT: [
        ...
        MODEL_TENSOR.FFN_DOWN_EXP,
        MODEL_TENSOR.FFN_UP_EXP,
        MODEL_TENSOR.CROSS_ATTN_Q, #HMT Architecture tensors
        MODEL_TENSOR.CROSS_ATTN_K,
        MODEL_TENSOR.SUMMARY_EMBEDDING,
        MODEL_TENSOR.INITIAL_MEMORY,
        MODEL_TENSOR.LINEAR_WEIGHT,
        MODEL_TENSOR.INV_WEIGHT
    ],
    MODEL_ARCH.LLAMA4: [
        MODEL_TENSOR.TOKEN_EMBD,
        MODEL_TENSOR.OUTPUT_NORM,
